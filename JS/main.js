...
const canvascurvas_cua = document.getElementById("canvascurvas_cua");
...
function drawrec() {
  ...
  function drawcurvas_cua() {
    
    if (canvascurvas_cua.getContext) {
      const ctx = canvascurvas_cua.getContext("2d");
